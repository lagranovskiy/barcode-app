...
@Component({
  selector: 'app-sauber-unsauber',
  templateUrl: './sauber-unsauber.component.html',
  styleUrls: ['./sauber-unsauber.component.scss']
})
export class SauberUnsauberComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.fragenEinleseService
      .leseFragebogen(Spieltyp.SAUBER_UNSAUBER)
  ...
  ergebnisSpeichern() {
    ...
    this.recordStorage.storeRecord(Spieltyp.SAUBER_UNSAUBER, record);
  }
